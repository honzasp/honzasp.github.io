...
(function() {
  define(["jquery", "game", "keycodes"], function($, Game, Keycodes) {
    ...
    return function($root) {
      var $menu, DEFAULT_STATE, build, buildFps, buildMap, buildMode, buildPlayer, buildPlayerKey, buildPlayers, buildStart, json, jsonTxt, keyName, save, selectKey, startGame, state;
      DEFAULT_STATE = {
        _version: 2,
        mapWidth: 100,
        mapHeight: 50,
