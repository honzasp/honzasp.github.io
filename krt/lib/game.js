...
(function() {
  define(["exports", "jquery", "map", "render", "tank", "bullet", "particle", "collisions", "update", "audio"], function(exports, $, Map, Render, Tank, Bullet, Particle, Collisions, Update, Audio) {
    var Game;
    Game = exports;
    Game.MAX_GARBAGE_RATIO = 0.5;
    Game.init = function(settings, onReady, onFinish) {
      var audio, audioReady, map, mapReady, ready;
      map = audio = void 0;
      ...
      Map.gen(settings, function(map_) {
        map = map_;
        mapReady = true;
        return ready();
      });
      Audio.init(settings, function(audio_) {
        audio = audio_;
        audioReady = true;
        return ready();
      });
