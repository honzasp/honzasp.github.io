...
(function() {
  define(["exports", "jquery", "map", "map_gen", "render", "tank", "bullet", "particle", "collisions", "update", "audio"], function(exports, $, Map, MapGen, Render, Tank, Bullet, Particle, Collisions, Update, Audio) {
    var Game;
    Game = exports;
