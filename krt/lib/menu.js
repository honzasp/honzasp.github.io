...
(function() {
  define(["exports", "jquery", "game", "keycodes", "menu_players", "menu_config"], function(exports, $, Game, Keycodes, MenuPlayers, MenuConfig) {
    var Menu;
    Menu = exports;
    ...
    Menu.startGame = function(menu) {
      ...
      return Game.init(settings, (function(game) {
        ...
        menu.game = void 0;
        return menu.$main.trigger("game-finished.krt");
      }));
    };
    return Menu;
  });
