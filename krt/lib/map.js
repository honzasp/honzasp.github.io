...
(function() {
  "use strict";
  define([], function() {
    var Map, genRocks, optimizeSquares;
    Map = {};
    ...
    genRocks();
    optimizeSquares = function() {
      var s, _base, _base1, _base2, _base3, _base4, _base5, _i;
      for (s = _i = 0; _i < 256; s = _i += 1) {
        if (Map.squares[s] != null) {
          (_base = Map.squares[s]).color || (_base.color = void 0);
          (_base1 = Map.squares[s]).toughness || (_base1.toughness = void 0);
          (_base2 = Map.squares[s]).prob || (_base2.prob = void 0);
          (_base3 = Map.squares[s]).energy || (_base3.energy = void 0);
          (_base4 = Map.squares[s]).mass || (_base4.mass = void 0);
          (_base5 = Map.squares[s]).shotSound || (_base5.shotSound = void 0);
        }
      }
      return void 0;
    };
