...
(function() {
  "use strict";
  define(["require", "map", "perlin"], function(require, Map, Perlin) {
    var MapGen;
    MapGen = {};
    MapGen.BASE_SIZE = 8;
    ...
    MapGen.TYPE_AMP = 0.7;
    MapGen.TYPE_SCALE = 8;
    MapGen.WORKER_TIMEOUT = function(width, height) {
      return 2 + width * height / (200 * 200);
    };
    MapGen.workerGen = function(settings, callback) {
      var fallback, finish, hasFinished, worker;
      hasFinished = false;
      finish = function(map) {
        if (!hasFinished) {
          hasFinished = true;
      ...
      fallback = function() {
        ...
        return setTimeout((function() {
          return finish(MapGen.gen(settings));
        }), 0);
      };
