...
(function() {
  define(["map", "tank", "bullet", "particle", "weapon"], function(Map, Tank, Bullet, Particle, Weapon) {
    ...
    Collisions.bullet = function(bullet, game, t) {
      var angle, end, fragment, fragmentCount, i, m, map, nearestHit, posX, posY, spec, start, tank, tankHit, tanks, toughness, velX, velY, _i, _j, _ref;
